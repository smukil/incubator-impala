...
#ifndef IMPALA_MINI_KDC_HELPER_H_
#define IMPALA_MINI_KDC_HELPER_H_
...
// If the class is KERBEROS_OFF, Impala's auth layer is configured to use plain SASL and
...
#endif /* IMPALA_MINI_KDC_HELPER_H_ */
