...
#ifndef IMPALA_RUNTIME_OLD_DATA_STREAM_SENDER_H
#define IMPALA_RUNTIME_OLD_DATA_STREAM_SENDER_H
...
class OldDataStreamSender : public DataSink {
 public:
  ...
  /// and RANDOM.
  OldDataStreamSender(int sender_id, const RowDescriptor* row_desc,
      const TDataStreamSink& tsink,
      const std::vector<TPlanFragmentDestination>& destinations,
      int per_channel_buffer_size);

  virtual ~OldDataStreamSender();
...
#endif /* IMPALA_RUNTIME_OLD_DATA_STREAM_SENDER_H */
